...
WEIGHT_UPPER_BOUND_DOC_RATIO=100#100 # Weight of prompting the VDF curve to 0 when the DOC is close to its maximum values
queue_demand_factor_method='SBM'




LINK_PERFORMANCE_TYPE=['single_day','multi_day']
...
MADATORY_TWO_WAY_LINK_FIELD=['ID','From ID','To ID', 'Dir','AB Length','BA Length','AB Lanes','BA Lanes','AB Speed','Link_type','BA Speed','FT','AT']
